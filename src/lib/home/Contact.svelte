<section id="contact" class="mb-2 text-neutral-200 text-center">
	<div
		...
		style="background-position: 50%; background-image: url('img/contact-bg.jpg');"
	>
		<div
			class="relative isolate overflow-hidden px-6 pt-16 sm:px-16 md:pt-24 lg:gap-x-20 lg:px-24 lg:pt-0"
		>
